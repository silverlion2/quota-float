...
- 当前源码、测试与公开发布状态见 [系统审查记录](REVIEW-2026-09-09.md)；源码能力和 CI 通过不自动代表已完成所有真实平台验收。
...
- 自动发布生成带 Tauri updater 签名的 Universal macOS 安装与更新产物，但透明窗口、菜单栏、拖动、三边 Bar 和实际更新安装仍缺少本轮真实 Mac 验证；Windows 运行结果和 macOS CI 构建不能替代该验证。
