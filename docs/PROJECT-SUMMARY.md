...
- 最新已公开 v0.3.17：参考 Vibe Usage 补齐自定义日期区间，联动本机用量、额度历史与导出，并修复滚动多日趋势的起始日漏计。日期语义见 [参考更新](VIBE-USAGE-REFERENCE-2026-09-17.md)；双平台构建、Defender、升级/回滚/卸载、六项资产摘要及双平台更新签名均通过，见 [发布记录](RELEASE-0.3.17.md)。
