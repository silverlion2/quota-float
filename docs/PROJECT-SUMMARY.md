...
- 最新已公开 v0.3.19：Bar / Bottleneck 随可见平台数量缩放，单平台侧栏缩至 64 × 156 逻辑像素，同步原生窗口并收紧展开布局。修复共享草稿与更新清单竞争，双平台包、实际 Defender 扫描、升级/回滚/卸载、六项资产哈希及更新签名均通过，见 [发布记录](RELEASE-0.3.19.md)。
