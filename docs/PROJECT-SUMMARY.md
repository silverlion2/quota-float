...
- 最新已公开 v0.3.15：Codex 扩展清单与六项伴侣目录，318 项前端、102 项 Rust、10 项 Windows 原生验收通过；Defender、升级/回滚/卸载和六项公开资产的摘要/更新签名完成复核。发布标签固定为 `f05e8697c390f36bba9f37ccad5ef5bfcb6fd43a`，发布后的记录提交仅含文档。完整证据见 [v0.3.15 发布记录](RELEASE-0.3.15.md)。
