...
- 2026-09-17 本地待发布：参考 Vibe Usage 补齐自定义日期区间，联动本机用量、额度历史与导出，并修复滚动多日趋势的起始日漏计。日期语义和验证见 [参考更新](VIBE-USAGE-REFERENCE-2026-09-17.md)。

- 2026-09-17 本地待发布：恢复重置预测常驻入口及失败保留，修正排除源有效期；Codex Profile 账户累计改取桌面同源接口，本机明细补归档目录并去重。范围与验证见 [预测可见性](RESET-VISIBILITY-2026-09-17.md) 和 [Profile 对齐](CODEX-PROFILE-2026-09-17.md)，不代表已更新公开安装包。
...
- 最新已公开 v0.3.16：重置历史核对与个人消耗计划；334 项前端、109 项 Windows Rust、11 项 Windows 原生测试通过，Defender、升级/回滚/卸载和六项公开资产摘要及双平台更新签名完成复核。发布标签固定为 `843c5f3b6fef2684487c9f920e1e0fcb185a3193`，发布后的记录提交仅含文档。完整证据见 [v0.3.16 发布记录](RELEASE-0.3.16.md)。
